...
// 기상청 API 엔드포인트
const API_ENDPOINT = 'https://apis.data.go.kr/1360000/VilageFcstInfoService_2.0';
const API_KEY = 'xe6%2F1dkLBOo4GmKdiGkFj1x7uqBZmNdR0LtBLCejOWVGHuNsQSE%2FXqo6qePDv%2B5PSsQ3ngor6pigpKS1OA1w3A%3D%3D';
 ...
 */
export async function getShortTermForecast(regionName: string): Promise<WeatherData[]> {
  try {
    // 공백 제거
